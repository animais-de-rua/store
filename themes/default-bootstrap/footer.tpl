		        ...
		        <div class="row">
		            <div class="large-4 medium-4 column fr" data-element="logo">
					    <span class="sprite-logo_icon ">
					        <img src="http://www.animaisderua.org/images/logo_icon.svg">
					    </span>
		            </div>
		                            ...
		                            <div class="mt-px10 primary-group email-group forms-builder-group ui-sortable" style="">
		                                <div class="mandatory-email">
		                                    ...
		                                    <button type="submit" name="subscribe" class="inline editable" data-editfield="subscribe">
		                                        <span class="sprite-button-arrow ">
											        <img src="http://www.animaisderua.org/images/button-arrow.svg">
											    </span>
		                                    </button>
		                                </div>
		                            </div>
		            ...
		            <div class="large-8 medium-8 column end mt-px60" data-element="social">
		                <h4>Redes Sociais</h4>
		                <div class="mt-px10">
		                    <a class="inline" target="_blank" href="http://www.facebook.com/animaisderua">
							    <span class="sprite-facebook_icon ">
							        <img src="http://www.animaisderua.org/images/facebook_icon.svg">
							    </span>
							</a>
		                    <a class="inline" target="_blank" href="https://www.youtube.com/user/animaisderuaAdR">
							    <span class="sprite-youtube_icon ">
							    	<img src="http://www.animaisderua.org/images/youtube_icon.svg">
							    </span>
							</a>
		                    <a class="inline" target="_blank" href="https://twitter.com/Animais_de_Rua">
							    <span class="sprite-twitter_icon ">
							        <img src="http://www.animaisderua.org/images/twitter_icon.svg">
							    </span>
							</a>
		                </div>
		            </div>
		...
		<script type="text/javascript">
			...
			$.ajax({
			    ...
			    success: function(data) {
			    	...
			    	var countNumber = parseInt(firstItem.contagem)+5849;
